...
Education
======
- **ShanghaiTech University**, Shanghai, China — Ph.D. candidate in bioinformatics

Research Interests
======
- Multi-omics analysis of primary and recurrent hepatocellular carcinoma (HCC)
- Single-cell genomics and computational method benchmarking
- Biomarker discovery for recurrence prediction and targeted therapy
...
- Patent: A biological contact oxidation device for wastewater treatment (Patent Substantive Examination Stage, Disclosure No. CN112979091A).

Skills
======
- Multi-omics and single-cell data analysis (WGS/WES, bulk and single-cell RNA-seq, proteomics)
- Python, R, Linux/HPC environments
